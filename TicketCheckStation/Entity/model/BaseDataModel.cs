  ...
  public   class BaseDataModel
    {
        ...
        {
            string condition = PublicColumns.add_time.ToString() + "> '" + table.syncUpTime.ToString(DateTimeFormat) + "' OR " + PublicColumns.last_update_time.ToString() + " > '" + table.syncUpTime.ToString(DateTimeFormat) + "'";
